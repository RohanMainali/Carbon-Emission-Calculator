document.addEventListener('DOMContentLoaded', function() {
    ...
    // Show loading animations for charts
    const emissionsChartLoading = document.getElementById('emissionsChartLoading');
    const vehicleEmissionsChartLoading = document.getElementById('vehicleEmissionsChartLoading');
    const emissionSourcesChartLoading = document.getElementById('emissionSourcesChartLoading');

    // Initialize charts with loading animations
    setTimeout(initializeEmissionsChart, 1500);
    setTimeout(initializeVehicleEmissionsChart, 2000);
    setTimeout(initializeEmissionSourcesChart, 2500);
    ...
    if (timeRangeFilter) {
        timeRangeFilter.addEventListener('change', function() {
            ...
            setTimeout(function() {
                ...
                // Show notification
                showNotification(`Chart updated to show data for the last ${timeRangeFilter.options[timeRangeFilter.selectedIndex].text}`);
            }, 1000);
        });
    }
});
...
function updateEmissionsChart(days) {
    ...
    const emissionsChart = Chart.getChart('emissionsChart');
    if (emissionsChart) {
