// Update the main.js file to include the community challenge link in the dropdown menu
  ...
  if (calculateBtn) {
    calculateBtn.addEventListener("click", (e) => {
      ...
      if (isLoggedIn) {
        ...
        // First show a prompt
        const promptMsg = confirm(
          "You need to create an account to calculate your carbon footprint. Would you like to sign up now?"
        );
        if (promptMsg) {
